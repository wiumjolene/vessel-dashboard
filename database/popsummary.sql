DELIMITER $$
CREATE DEFINER=`agrihub`@`%` PROCEDURE `popsummarytable`()
BEGIN
...
       from data_raisins a, dim_variety b
    ...
    -- insert new data
      ...
      shipped_week_za, shipped_week_pol, iso_port, port_country, port_region, exporter_region, combo_region,
      ...
      grade,voyage,transport, size_count,id_vessel, act_ctns,eqv_ctns,plt_qty,mass)
        ...
        from (
            ...
            LEFT JOIN (SELECT  sd.id_vessel, load_port, load_port_assign, 
